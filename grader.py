...
def grade(config_path="autograde_config.json",
    ...
    # Build system and user messages for the completions API
    ...
    user_msg = textwrap.dedent(f"""\
        ...
        Does this code meet the assignment requirements? Answer only 'yes' or 'no'.
    """)
    ...
    # Generate feedback
    if passed:
        feedback_system_msg = "You are a kind mentor. Give one upbeat sentence of praise."
        feedback_user_msg = code
    else:
        feedback_system_msg = ("You are a kind mentor. In <=2 short sentences explain "
